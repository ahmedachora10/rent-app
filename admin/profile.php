...
<body dir='rtl'>
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
                                    ...
                                    if($query->rowCount() > 0)
                                    {
                                        ...
                                        {  
                                            ...
                                            <form method="post">
                                                ...
                                                <div class="form-group row">
                                                    <label class="" for="register1-email">الاسم الاول: 
                                                    </label>
                                                    <div class="col-12">
          ...
          <br><br>
          <button type="submit" name="submit" class="btn btn-primary btn-fw mr-2" style="float: right;">تعديل</button>
      </form>
  </div>
</div>
</div>
