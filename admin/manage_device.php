...
$sql = "UPDATE devices set block_status=0  WHERE  id=:statid ";
              ...
              <div class="card">
                ...
                <div class="table-responsive p-3" style="float: right;">
                  <table class="table align-items-center table-flush table-hover table-bordered" id="dataTableHover" style="float: right;">
                    ...
                    <tbody>
                      <?php
                      $sql = "SELECT * from devices where block_status='1'";
                      $query = $dbh -> prepare($sql);
                      $query->execute();
                        ...
                        { 
                          ...
                          <tr>
                            ...
                            <?php
                              if($status==1){
                                ?>
                               <a href="del_device.php?del=<?php echo $row->id;?>" onclick="return confirm('هل تريد الحذف');"><i class="mdi mdi-delete"></i></i></a>
                               &nbsp; &nbsp; &nbsp;
