        ...
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="dashboard.php">
                    <i class="mdi mdi-home menu-icon ml-2">
                    </i>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="ui-basic">
                    <ul class="nav flex-column sub-menu pr-4 mb-0">
                        <li> <a class="nav-link my-2 py-0" href="register_device.php">إضافة جهاز</a></li>
                        <li> <a class="nav-link my-2 py-0" href="manage_myDevices.php">إدارة أجهزتي</a></li>
                    </ul>
                </div>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="general-pages">
                    ...
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item">&nbsp;&nbsp; <a class="nav-link" href="userregister.php">إضافة مستخدم </a>
                        </li>
                        <li class="nav-item"> <a class="nav-link" href="customers.php">إدارة المستخدمين</a>&nbsp;&nbsp;
                        </li>
