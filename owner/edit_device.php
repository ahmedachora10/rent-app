          ...
          <form class="forms-sample" method="post" enctype="multipart/form-data" class="form-horizontal">
            <div class=" col -md-12 card">
              <div class="modal-header">
                <h5 class="modal-title" style="float: right;">تعديل الجهاز</h5>
              </div>
              <?php
              if($error){?>
                <div class="errorWrap">
                  ...
                  <div class="col-md-12 mt-4">
                    <div class="row ">
                      <div class="form-group col-md-6">
                        <label for="exampleInputName1" style="float: right;">اسم الجهاز<span style="color:red">*</span></label>
                        <input type="text" name="name" class="form-control"  value="<?php echo htmlentities($result->device_name)?>"  id="product" readonly>
                      </div>
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <div class="form-group col-md-3">
                        <label for="exampleInputName1" style="float: right;">سعر الجهاز باليوم <span style="color:red">*</span></label>
              ...
              <button type="submit" style="float: right;" name="save" class="btn btn-primary btn-sm  mr-2 mb-4">حفظ</button>
            </div>
          </div>
          <?php 
        }
