...
<?php include('includes/header.php'); ?>
    ...
    <div class="container-fluid pt-5 pb-3">
        ...
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3"> الاجهزة الكهربائية</span></h2>
        <div class="row px-xl-5">
        <?php
                        $sql="SELECT * from devices where device_type='electronics' and block_status=1";
