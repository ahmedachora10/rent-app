...
<div id="forgotpassword" class="modal fade">
        ...
        <div class="login_wrap">
          <div class="col-md-12 col-sm-6">
           <form name="chngpwd" method="post" onSubmit="return valid();">
            ...
            <div class="form-group">
              <input type="submit" value="حفظ" name="update" class="btn btn-block" style="background-color: #49a3ff;">
            </div>
          </form>
        </div>
      </div>
  ...
  <div class="modal-footer ">
    <p><a href="#loginform" data-toggle="modal" data-dismiss="modal"><i class="fa fa-angle-double-left" aria-hidden="true"></i>العودة لتسجيل الدخول</a></p>
  </div>
</div>
